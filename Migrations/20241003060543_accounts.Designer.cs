...
namespace Lab1_WebAPI_Db_Resto.Migrations
{
    ...
    [Migration("20241003060543_accounts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lab1_WebAPI_Db_Resto.Models.Account", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lab1_WebAPI_Db_Resto.Models.Booking", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FK_CustomerId = 2,
                            ReservationEnd = new DateTime(2024, 10, 3, 10, 5, 42, 448, DateTimeKind.Local).AddTicks(8858),
                            ReservationStart = new DateTime(2024, 10, 3, 8, 5, 42, 448, DateTimeKind.Local).AddTicks(8791),
                            TimeStamp = new DateTime(2024, 10, 3, 8, 5, 42, 448, DateTimeKind.Local).AddTicks(8863)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            FK_CustomerId = 2,
                            ReservationEnd = new DateTime(2024, 10, 3, 10, 5, 42, 448, DateTimeKind.Local).AddTicks(8871),
                            ReservationStart = new DateTime(2024, 10, 3, 8, 5, 42, 448, DateTimeKind.Local).AddTicks(8868),
                            TimeStamp = new DateTime(2024, 10, 3, 8, 5, 42, 448, DateTimeKind.Local).AddTicks(8874)
                        });
                });
            ...
            modelBuilder.Entity("Lab1_WebAPI_Db_Resto.Models.Meal", b =>
                {
                    ...
                    b.Property<int?>("FK_MealCategoryId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Lab1_WebAPI_Db_Resto.Models.Meal", b =>
                {
                    b.HasOne("Lab1_WebAPI_Db_Resto.Models.MealCategory", "MealCategory")
                        .WithMany("Meals")
                        .HasForeignKey("FK_MealCategoryId");
